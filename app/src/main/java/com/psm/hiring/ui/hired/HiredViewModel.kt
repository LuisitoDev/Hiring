...
class HiredViewModel : ViewModel() {

    private var _hiredLiveData : MutableLiveData<ArrayList<Solicitudes_Model>> = MutableLiveData<ArrayList<Solicitudes_Model>>()
    private lateinit var _hiredArrayList : ArrayList<Solicitudes_Model>

    init {

    }

    fun getHiredMutableLiveData() : MutableLiveData<ArrayList<Solicitudes_Model>>{
        return _hiredLiveData
    }
    ...
    private fun populatelist(idTrabajo : String?) {
        ...
        solicitud.StatusSolicitud = "Aceptada"
    ...
    private fun updateMutableLiveDataVisualizeSolicitudes(solicitudesResponse : ArrayList<Solicitudes_Model>){
        _hiredArrayList = solicitudesResponse
        _hiredLiveData.value = _hiredArrayList
    }
